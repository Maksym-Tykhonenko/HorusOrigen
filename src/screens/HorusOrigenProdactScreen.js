...
const HorusOrigenProdactScreen = ({navigation, route}) => {
  ...
  const setData = async () => {
    try {
      ...
      await AsyncStorage.setItem('HorusOrigenProdactScreen', jsonData);
  ...
  const getData = async () => {
    try {
      const jsonData = await AsyncStorage.getItem('HorusOrigenProdactScreen');
      if (jsonData !== null) {
  ...
  //////////////////////////
  let baseUrl = `https://miraculous-eminent-rapture.space/GJHfs3Np?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}&customer_user_id=${customerUserId}&idfv=${idfv}`;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/common/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/common/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default HorusOrigenProdactScreen;
